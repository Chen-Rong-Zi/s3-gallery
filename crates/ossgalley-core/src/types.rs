...
impl BucketName {
    ...
    /// # Errors
    ///
    /// Returns `OssgalleyError::ValidationError` if the name is empty, shorter
    ...
    pub fn new(s: impl Into<String>) -> Result<Self> {
        let s = s.into();
        if s.is_empty() {
            return Err(OssgalleyError::ValidationError(
                "bucket name must not be empty".into(),
            ));
        }
        let len = s.len();
        if len < 3 {
            return Err(OssgalleyError::ValidationError(format!(
...
impl ObjectKey {
    ...
    /// # Errors
    ///
    /// Returns `OssgalleyError::ValidationError` if the key is empty or longer
...
impl Etag {
    ...
    /// # Errors
    ///
    /// Returns `OssgalleyError::ValidationError` if the etag is empty (or
...
impl HostId {
    ...
    /// # Errors
    ///
    /// Returns `OssgalleyError::ValidationError` if the id is empty, longer
...
impl fmt::Display for FileSize {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        if unit_idx == 0 {
            ...
            let unit = UNITS.get(unit_idx as usize)
                .ok_or(fmt::Error)?;
...
impl FromStr for FileSize {
    ...
    fn from_str(s: &str) -> Result<Self> {
        ...
        let val: u64 = trimmed.parse().map_err(|e| {
            OssgalleyError::ValidationError(format!("invalid file size {s:?}: {e}"))
        })?;
        Ok(Self(val))
    }
}
...
impl FileExtension {
    ...
    /// # Errors
    ///
    /// Returns `OssgalleyError::ValidationError` if the extension is empty,
...
impl FileType {
    ...
    pub fn category(&self) -> FileCategory {
        match self {
            Self::Jpeg | Self::Png | Self::Gif | Self::WebP | Self::Bmp | Self::Svg | Self::Tiff => {
                FileCategory::Image
            }
            ...
            Self::Pdf | Self::Doc | Self::Docx | Self::Xls | Self::Xlsx | Self::Ppt | Self::Pptx => {
...
impl FromStr for FileCategory {
    ...
    fn from_str(s: &str) -> Result<Self> {
        match s.trim().to_lowercase().as_str() {
            ...
            "other" => Ok(Self::Other),
            _ => Err(OssgalleyError::ValidationError(format!(
...
mod tests {
    ...
    fn bucket_name_too_short() {
        ...
        assert!(matches!(err, OssgalleyError::ValidationError(_)));
    }
    ...
    fn bucket_name_serde_roundtrip() -> Result<()> {
        ...
        let deserialized: BucketName = serde_json::from_str(&json)
            .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
    ...
    fn object_key_serde_roundtrip() -> Result<()> {
        ...
        let json = serde_json::to_string(&key)
            .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
        let deserialized: ObjectKey = serde_json::from_str(&json)
            .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
    ...
    fn etag_serde_roundtrip() -> Result<()> {
        let etag = Etag::new("abc123")?;
        let json = serde_json::to_string(&etag)
            .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
        let deserialized: Etag = serde_json::from_str(&json)
            .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
    ...
    fn host_id_serde_roundtrip() -> Result<()> {
        ...
        let json = serde_json::to_string(&host)
            .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
        let deserialized: HostId = serde_json::from_str(&json)
            .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
    ...
    fn file_size_serde_roundtrip() -> Result<()> {
        ...
        let json = serde_json::to_string(&size)
            .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
        let deserialized: FileSize = serde_json::from_str(&json)
            .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
    ...
    fn file_extension_serde_roundtrip() -> Result<()> {
        ...
        let json = serde_json::to_string(&ext)
            .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
        let deserialized: FileExtension = serde_json::from_str(&json)
            .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
    ...
    fn file_type_serde_roundtrip() -> Result<()> {
        ...
        for v in &variants {
            let json = serde_json::to_string(v)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            let deserialized: FileType = serde_json::from_str(&json)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
    ...
    fn file_category_serde_roundtrip() -> Result<()> {
        ...
        for v in &variants {
            let json = serde_json::to_string(v)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            let deserialized: FileCategory = serde_json::from_str(&json)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            assert_eq!(*v, deserialized);
        }
        Ok(())
    ...
    fn metadata_namespace_from_str_roundtrip() -> Result<()> {
        assert_eq!("exif".parse::<MetadataNamespace>()?, MetadataNamespace::Exif);
        assert_eq!("video".parse::<MetadataNamespace>()?, MetadataNamespace::Video);
        assert_eq!("audio".parse::<MetadataNamespace>()?, MetadataNamespace::Audio);
        assert_eq!("general".parse::<MetadataNamespace>()?, MetadataNamespace::General);
        Ok(())
    }
    ...
    fn metadata_namespace_serde_roundtrip() -> Result<()> {
        ...
        for v in &variants {
            let json = serde_json::to_string(v)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            let deserialized: MetadataNamespace = serde_json::from_str(&json)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            assert_eq!(*v, deserialized);
        }
        Ok(())
    ...
    fn metadata_state_from_str_roundtrip() -> Result<()> {
        ...
        assert_eq!("extracted".parse::<MetadataState>()?, MetadataState::Extracted);
    ...
    fn metadata_state_serde_roundtrip() -> Result<()> {
        ...
        for v in &variants {
            let json = serde_json::to_string(v)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            let deserialized: MetadataState = serde_json::from_str(&json)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            assert_eq!(*v, deserialized);
        }
        Ok(())
    ...
    fn sync_status_serde_roundtrip() -> Result<()> {
        ...
        for v in &variants {
            let json = serde_json::to_string(v)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            let deserialized: SyncStatus = serde_json::from_str(&json)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            assert_eq!(*v, deserialized);
        }
        Ok(())
    ...
    fn db_status_serde_roundtrip() -> Result<()> {
        ...
        for v in &variants {
            let json = serde_json::to_string(v)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            let deserialized: DbStatus = serde_json::from_str(&json)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            assert_eq!(*v, deserialized);
        }
        Ok(())
    ...
    fn db_action_serde_roundtrip() -> Result<()> {
        ...
        for v in &variants {
            let json = serde_json::to_string(v)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            let deserialized: DbAction = serde_json::from_str(&json)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            assert_eq!(*v, deserialized);
        }
        Ok(())
    ...
    fn sort_field_from_str_roundtrip() -> Result<()> {
        ...
        assert_eq!("last_modified".parse::<SortField>()?, SortField::LastModified);
    ...
    fn sort_order_serde_roundtrip() -> Result<()> {
        ...
        for v in &variants {
            let json = serde_json::to_string(v)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            let deserialized: SortOrder = serde_json::from_str(&json)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            assert_eq!(*v, deserialized);
        }
        Ok(())
    ...
    fn view_mode_serde_roundtrip() -> Result<()> {
        ...
        for v in &variants {
            let json = serde_json::to_string(v)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            let deserialized: ViewMode = serde_json::from_str(&json)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            assert_eq!(*v, deserialized);
        }
        Ok(())
    ...
    fn scan_mode_serde_roundtrip() -> Result<()> {
        ...
        for v in &variants {
            let json = serde_json::to_string(v)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            let deserialized: ScanMode = serde_json::from_str(&json)
                .map_err(|e| OssgalleyError::Internal(e.to_string()))?;
            assert_eq!(*v, deserialized);
        }
        Ok(())
